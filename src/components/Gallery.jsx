      ...
      <section className="gallery">
        ...
        <div className="photo">
          <div className="photo-item">
            ...
            <div className="info">Pameran Seni</div>
          </div>
          <div className="photo-item">
          ...
          <div className="photo-item">
            ...
            <div className="info">Pameran Seni Memori Benda</div>
          </div>
          <div className="photo-item">
            <img src={Component11} alt="Informasi Gambar 5" />
            <div className="info">Pameran Sebi Budaya</div>
          </div>
          <div className="photo-item">
            <img src={Component12} alt="Informasi Gambar 6" />
            <div className="info">Pameran Fotografi</div>
          </div>
          <div className="photo-item">
          ...
          <div className="photo-item">
            ...
            <div className="info">Pameran Seni Lukis</div>
          </div>
        </div>
      </section>
    );
